        ...
        <div class="container">
            ...
            <nav class="social pull-right">
                <ul class="list-unstyled">
                    ...
                    <a href="../home/index.php" style=" font-size:15pt;color: #e8e51c;">Home
                    </a></li>
                    <li class="animated wow fadeInRight" data-wow-delay=".2s">
                    <a href="../home/index.php" style=" font-size:15pt;color: #e8e51c;">About
                    </a></li>
                    <!-- <li class="animated wow fadeInRight" data-wow-delay=".3s">
                    <a href="../home/index.php" style=" font-size:15pt;color: #e8e51c;">Github
                    </a></li> -->
